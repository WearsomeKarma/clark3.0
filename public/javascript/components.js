...
function apply_header(is_authenticated) {
    $('#header').append(get_header(is_authenticated));
}

function get_header(is_authenticated) {
    return `
    ...
    +
        ...
        :
        `
            <div class="navbar-brand mb-0 logout">Hello, <a id="showname" href="/account"></a></div>
